...
if ( '' !== $twitter ) {
	echo '<span class="twitter"><a class="staff-member-twitter" href="https://twitter.com/' . esc_attr( $twitter ) . '" title="Follow ' . esc_attr( get_the_title() ) . ' on Twitter">' . file_get_contents( STAFFLIST_URI . 'public/svg/twitter.svg' ) . '</a></span>';
}
