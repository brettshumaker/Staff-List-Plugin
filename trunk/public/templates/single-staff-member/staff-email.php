...
if ( '' !== $email ) {
	echo '<span class="email"><a class="staff-member-email" href="mailto:' . esc_attr( antispambot( $email ) ) . '" title="Email ' . esc_attr( get_the_title() ) . '">' . file_get_contents( STAFFLIST_URI . 'public/svg/envelope.svg' ) . '</a></span>';
}
