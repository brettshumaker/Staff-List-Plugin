...
$output      = '<div class="wrap sslp-options">';
	...
	$output         .= '<div class="sslp-content sslp-column">';
		$output     .= '<form method="post" action="">';
			...
			$output .= '<input type="text" name="staff-listing-slug" value="' . esc_attr( $custom_slug ) . '"></fieldset>';
			$output .= '<p>' . __( 'The slug used for building the staff members URL. The current URL is: ', 'simple-staff-list' );
			$output .= site_url( esc_url( $custom_slug ) ) . '/';
			$output .= '</p>';
			...
			$output .= '<input type="text" name="staff-listing-name-plural" value="' . esc_attr( $custom_name_plural ) . '"></fieldset>';
			...
			$output .= '<input type="text" name="staff-listing-name-singular" value="' . esc_attr( $custom_name_singular ) . '"></fieldset>';
